...
The steering committee is currently developing a proposal form for both 1) and 2) and a publication policy for these proposals. This which will be posted soon.   

## Publication policy

There is a broad level publication policy written into the [Codes of conduct](http://www.godmc.org.uk/codesofconduct.pdf). The steering committee is currently writing a more detailed publication policy, and this will be posted soon.

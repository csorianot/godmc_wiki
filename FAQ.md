...
For further details, click [here](http://www.godmc.org.uk/information.html). See [here](#publication-policy) for the publication policy.


## Publication policy

There is a broad level publication policy written into the [Codes of conduct](http://www.godmc.org.uk/codesofconduct.pdf). The steering committe is currently writing a more detailed publication policy, and this will be posted soon.

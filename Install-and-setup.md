...
- `results` directory: This will be where the scripts store results from the analyses. It also contains log files (e.g. `results/01/logs`) of the analysis. At the end of running each script please check these files. **You do not need to manually change any of these files**.
